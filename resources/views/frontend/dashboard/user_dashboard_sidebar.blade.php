...
<div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
    ...
    <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
        ...
        <li class="{{ $route == 'user.leaderboard' ? 'active' : '' }}">
            <a href="{{ route('user.leaderboard') }}">
                <svg class="mr-2" viewBox="0 0 24 24" width="18px" height="18px"><path fill="none" d="M0 0h24v24H0z"/><path d="M16 11V3H8v6H2v12h20V11h-6zm-6-6h4v14h-4V5zm-6 6h4v8H4v-8zm16 8h-4v-6h4v6z"/></svg> Leaderboard
            </a>
        </li>
        ...
        <li class="{{ $route == 'user.purchase.history' ? 'active' : '' }}">

    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            ...
            @foreach ($categories as $index => $item)
                <li class="nav-item">
                    <a class="nav-link {{ $index == 0 ? 'active' : '' }}" id="{{ $item->slug }}-tab" data-bs-toggle="tab"
                                    ...
                                    <div class="card card-item card-preview"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="icon-element icon-element-sm shadow-sm cursor-pointer add-to-cart-btn ml-1"
                                                    title="Add to Cart" data-course-id="{{ $course->id }}">
